...
import { useLogout } from "../hooks/autoHooks";
...
export const Profile = () => {
  ...
  const { mutate: logout, isLoading: isLoginLoading } = useLogout();
          ...
          <div className="w-full md:w-2/3 bg-gray-100 p-6 rounded-lg shadow">
            {activeTab === "profile" && (
              <div>
                ...
                <p className="mb-2">
                  <strong>Name</strong> John skut
                </p>
                <p className="mb-2">
                  <strong>Username</strong> May 15, 2023
                </p>
                <p className="mb-2">
                  <strong>Username</strong> May 15, 2023
                </p>
