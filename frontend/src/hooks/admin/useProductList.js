...
export default function useProductList({ page, searchQuery, sortBy, limit, category, collaboration }) {
    return useQuery(
      ...
      async () => {
        ...
        collaboration && collaboration !== "all" && params.append("collaboration", collaboration);
